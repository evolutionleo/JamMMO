...
module.exports = packet = {
    ...
    build: function(params) {
        console.log('packing: '+params.toString());
    ...
    parse: function(c, data) {
        ...
        while(idx < data.length) {
            ...
            var packSize = data.readInt8(idx);
        ...
        // this.interpret(c, data);
    },

    interpret: function(c, datapack) {
        // let header = PacketModels.header.parse(datapack);
        console.log('Received');
        console.log(datapack.toString('utf-8'));

        var data = decode(datapack);
        // console.log(data);
        ...
        switch(data.cmd) {
            case "HELLO":
                ...
                c.socket.write(packet.build({cmd: "HELLO", str: "No Fuck You!"}))
                c.socket.write(packet.build({cmd: "HELLO", str: "No Fuck You 2!"}))
                break;
            case "PLAYER":
                var pack = {
                    cmd: "PLAYER",
